        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
              <button class="navbar-toggler navbar-toggler align-self-center" type="button" >
          <span ><a href="login.php"><font color="#00308f"> <b>sign in &nbsp;&nbsp;&nbsp;</b></font></a></span>
        </button>
                       </a>
...
<br><br><br><br>
<center>
     <form action="dosaaving.php " method="post" width="44" height="50">
	          
        <section class="login">
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="images/signi.jpg" alt="sing up image" ></figure>
			...
			{
			$msg=$_REQUEST['msg'];
				echo '<span style="color:#ed2939;text-align:center;"><b>'.$msg.'</span>';
			}
		  ?>   
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="your_email" placeholder="Your email" class="form-control" required>
								<i class="error error-icon fas fa-exclamation-circle"></i>
                            </div>
                            <div class="form-group">
                                <label for="your_pass"><i class="zmdi zmdi-lock"></i></label>
                                <input type="password" name="password" id="your_pass" placeholder="Password" class="form-control" required>
                            </div>
