...
<body>
  ...
  <div class="col-lg-10 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <?php
                  if(isset($_REQUEST['msg2']))
                  {
                      ...
                      echo '<span colspan="2" align="center" style="color:#00FF00;">'.$_REQUEST['msg2'].'</span>';
         ...
         <div class="form-group">
					...
					<input type="submit" class="btn btn-primary col-md-1 col-md-offset-1" value="Search" name="batch" />
...
<?php
		...
		?>
		<td>
		  <input type="hidden" name="bch_id" id="bch_id" value="<?php echo  $batch; ?>">
		    <input type="hidden" name="div_idd" id="div_idd" value="<?php echo $div; ?>">
		<select class="form-control" id="div_id" name="<?php echo $j.$i;?>">
...
<table>
			   ...
			   <button type="submit" name="addtimetable" class="btn btn-primary mr-6" value="addtimetable">create</button></th>
	...
	<!-- <td>
	 ...
	 <form action="dosaaving.php" method="post" enctype="multipart/form-data">          
      ...
      <div class="form-group">
          ...
          <input type="hidden" name="bch_id" id="bch_id" value="<?php echo $row['bch_id']; ?>">
              
						<button type="submit"  class="btn btn-inverse-danger btn-fw" name="deletebatch" >Delete</button>
