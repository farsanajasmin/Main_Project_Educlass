...
<body>
    ...
    <div class="container-fluid page-body-wrapper">
	  ...
	  ?>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="sub_name" placeholder="subject" name="sub_name" required>
                    </div>
                    
                   <!-- <div class="form-group">
                      <label for="exampleInputPassword1">date</label>
                      <input type="date" class="form-control" id="date" placeholder="creation date:dd/mm/yyy" name="date" required>
                    </div>
                    <div class="form-group">
					...
					<table>
					<tr>
                   <th> <button type="submit" name="addsub" class="btn btn-primary mr-2">Add</button></th>
                     
                  </form>
				 <form>
				 <th> <button class="btn btn-light" onClick="document.location.href='addsub.php'"/>Cancel</button></th></tr>
				  </form>
				  </table>
            </div>
          </div>
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Subject List</b></h3></td>
   </tr> 
      <tr class="table-info">
  ...
  <tr>
    ...
    <td> <form action="editsubject.php" method="post" enctype="multipart/form-data" >          
               
	
      <div class="form-group">
                     
                    </div>
 <input type="hidden" name="sbid" id="sbid" value="<?php echo $row['sbid']; ?>">
              <button type="submit" class="btn btn-primary btn-icon-text" name="editsubject">
	 ...
	 <td>
						...
						<button type="submit"  class="btn btn-inverse-danger btn-fw"><?php echo "<a onClick=\"javascript:return confirm('Are You Confirm To Delete Subject');\"href='dosaaving.php?deletesub={$row['sbid']}'>Delete</a>";
