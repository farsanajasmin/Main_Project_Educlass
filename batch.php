...
<body>
  <div class="container-scroller">
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputUsername1" value="<?php echo $year;?>" name="bch_name" readonly>
                    </div>
                    <div class="form-group">
					...
					<tr>
					<th>
                 <button type="submit" name="addbatch" class="btn btn-primary mr-2" value="addbatch">Add</button></th>
                    </form>
                    <form>
   ...
   <td colspan="10" align="center"><h3><b>Batch</b></h3></td>
	...
	<?php
	$sql="SELECT * FROM tbl_batch ORDER BY bch_name ASC";
