	  ...
	  
{
   ...
   $sql="SELECT * FROM tbl_division where div_id=$div_id";
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                    ...
                    <div class="form-group">
			         ...
			         <input type="hidden" name="div_id" id="div_id" value="<?php echo $row['div_id']; ?>">
                      <input type="text" class="form-control" id="division" placeholder="division" value=<?php echo $division; ?> name="division" required>
                     </div>
                    ...
                    <button type="submit" name="updatedivision" class="btn btn-primary mr-2" value="updatedivision">update</button>
...
?>
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Division</b></h3></td>
   </tr> 
      <tr class="table-info">
  ...
  <tr>
	...
	<form action="editdivision.php" method="post" enctype="multipart/form-data" >          
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="div_id" id="div_id" value="<?php echo $row['div_id']; ?>">
              <button type="submit" class="btn btn-primary btn-icon-text" name="editdivision">
