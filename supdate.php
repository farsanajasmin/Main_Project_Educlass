...
<body>
 ...
 $sql="SELECT * FROM tbl_studentregister where email='$msg2'";
    ...
    $sql1 = "UPDATE `tbl_studentregister` SET `name`='$name',`address`='$address',`gender`='$gender',`ac_no`='$ac_no',`phone`='$phone',`password`='$password'  WHERE email='$msg2'" ;
