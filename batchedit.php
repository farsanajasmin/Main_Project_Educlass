...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
	  ...
	  <?php
	  if(isset($_POST['bchedit']))
	  
{
	//$regno=$_POST['regno']; 
	  $bch_id=$_POST['bch_id'];
}
   $sql="SELECT * FROM tbl_batch where bch_id=$bch_id";
	...
	?>
          ...
          <div class="col-lg-4 mx-auto">
			...
			<input type="hidden" name="bch_id" id="bch_id" value="<?php echo $row['bch_id']; ?>">
                      <input type="text" class="form-control" id="batch" placeholder="class" value=<?php echo $bch_name; ?> name="batch" required>
                    </div>
<div class="col-sm-15">
 <label for="exampleInputEmail1"> Class</label>
                            <select class="form-control" id="c_id" name="c_id">
                               <?php
                    $sql="SELECT c_id,class FROM tbl_class";
		...
		
                    {
                        ...
                        //else
                             echo '<option value="'.$row['c_id'].'" >'.$row['class'].'</option>';
                    }
                    ?>
                            </select>
                          </div><br>
                    ...
                    <div class="form-group">
                      ...
                      <input  class="form-control" id="date"value=<?php echo date('Y-m-d'); ?>  name="date" readonly>
                    </div>

                    <div class="form-check form-check-flat form-check-primary">
                    
                    </div>
                    <button type="submit" name="updatebatch" class="btn btn-primary mr-2" value="updatebatch">Update</button>
         ...
         <div class="col-lg-6 grid-margin stretch-card">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Batch</b></h3></td>
   </tr> 
      <tr class="table-info">
  ...
  <tr>
    <td><?=$bch_name?></td>
	<td> <form action="batchedit.php" method="post" enctype="multipart/form-data" >          
      ...
      <div class="form-group">
          ...
          <input type="hidden" name="bch_id" id="bch_id" value="<?php echo $row['bch_id']; ?>">
              <button type="submit" class="btn btn-primary btn-icon-text" name="bchedit">
