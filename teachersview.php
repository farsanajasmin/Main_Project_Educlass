...
<body>
  <div class="container-scroller">
    ...
    <!-- Main css -->
           ...
           <div class="col-lg-10 stretch-card">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Teachers List</b></h3></td>
   </tr> 
     <tr class="table-info">
	    <!--<th align="left" >register</th>-->
         <th align="left" >Name</th>
		   <th align="left" >Email</th>
		   <th align="left" >Update/Resign</th>
		 
       
    </tr>
	<?php
	$sql="SELECT t_id,name,email FROM tregister WHERE status!='1'";
  ...
  <tr>
    ...
    <td><?=$name?></td>
	 <td><?=$email?></td>
	 <td>
				<button  type="button" class="btn btn-primary btn-xs dt-edit"> <a href="tupdate.php?id=<?php echo $row['t_id'];?>"> 
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"><font color="white" >Update</font></span></a>
				</button>
				
					<button  type="button"class="btn btn-danger btn-xs dt-delete"> <a href="delete.php?id=<?php echo $row['t_id'];?>"> 
					<span class="glyphicon glyphicon-pencil" aria-hidden="true"><font color="white" >Resign</font></span></a>
				</button></br>
