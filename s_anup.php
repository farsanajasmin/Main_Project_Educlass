...
<body>
        ...
        <!-- Sign up form -->
		  ...
		  <table class="table table-bordered">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Answer Upaload</b></h3></td><br>
   </tr> 
...
<tr>
	<?php
					  ...
					  $sql5="SELECT * FROM tbl_studentregister where email='$msg'";
		   ...
		   $date= date('Y-m-d'); ?>
			 ...
			 <form action="" method="post" enctype="multipart/form-data" >
					...
					<td><div class="form-group">
                      <label for="exampleInputUsername1">answer</label><br><br><br>
                       <input type="file" name="myfile"> <br>
                    </div>
          
                 <button type="submit" name="addshedule" class="btn btn-primary mr-2" value="addshedule">Add</button>
                    <button class="btn btn-light">Cancel</button></td></tr>
...
if (isset($_POST['addshedule'])) { // if save button on the form is clicked
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
        ...
        #
            $sql = "INSERT INTO tbl_answers (anwer_name,size,subject,bch_id,stu_id,date,division,title,max) VALUES ('$filename','$size','$sbid',' $batch','$stu_id','$date','$division','$title','$max')";
