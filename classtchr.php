         ...
         <div class="form-group">
					  ...
					  <div class="col-sm-15">
                            <select class="form-control" id="bch_id" name="bch_id">
                               <?php
                    $sql1="SELECT bch_id,bch_name FROM tbl_batch";
		...
		
                    {
                        ...
                        //else
                             echo '<option value="'.$row1['bch_id'].'" >'.$row1['bch_name'].'</option>';
                    }
                    ?>
                            </select>
                          </div>
					...
					-->
					<div class="col-sm-15">
                            <select class="form-control" id="div_idd" name="div_idd">
                               <?php
					...
					<input type="submit" class="btn btn-primary col-md-5 col-md-offset-5" value="Search" name="batch" />
               
</form>
<form action="dosaaving.php" method="post" class="form-horizontal col-md-15 col-md-offset-10">
                    <div class="form-group">
                     <!-- <label for="exampleInputPassword1">Date</label>-->
                      <input  type="hidden" class="form-control" id="exampleInputPassword1" value=<?php echo date('Y-m-d'); ?> name="date" readonly>
...
global $div;
 if(isset($_POST['div_idd']))
	 ...
	 ?>  
 <input  type="hidden" class="form-control" id="exampleInputPassword1" value=<?php echo $batch; ?> name="batch" >
 <input  type="hidden" class="form-control" id="exampleInputPassword1" value=<?php echo $div; ?> name="division" >
                    </div>	 
...
<?php
		...
		?>
		<td>
		<label for="exampleInputPassword1">Assign Class Teacher</label>
		<select class="form-control" id="ctchr" name="ctchr">
...
<table>
			   ...
			   <button type="submit" name="addclasstchr" class="btn btn-primary mr-6" value="addclasstchr">Assign</button></th>
         ...
         <div class="col-lg-6 grid-margin stretch-card">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Class Teacher</b></h3></td>
   </tr> 
      <tr class="table-info"">
	...
	<?php
	$sql="SELECT tbl_batch.bch_name,tbl_classtchr.cst_id,tbl_division.division,tregister.name,tbl_subjects.sub_name, tbl_cst.date,tbl_cst.cst_id FROM tbl_classtchr,tbl_cst LEFT JOIN tbl_batch ON tbl_cst.bch_id=tbl_batch.bch_id LEFT JOIN tbl_division ON tbl_cst.division=tbl_division.div_id LEFT JOIN tregister ON tbl_cst.t_id=tregister.t_id LEFT JOIN tbl_subjects ON tbl_cst.sbid=tbl_subjects.sbid where tbl_cst.cst_id=tbl_classtchr.cst_id";
  ...
  <tr>
	...
	<button type="submit"  class="btn btn-inverse-danger btn-fw"><?php echo "<a onClick=\"javascript:return confirm('Are You Confirm To Delete Subject');\"href='dosaaving.php?deleteclstchr={$row['cst_id']}'>Delete</a>";
