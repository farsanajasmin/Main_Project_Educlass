  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end"  >
		...
		<button class="navbar-toggler navbar-toggler align-self-center" type="button" >
          <span ><a href=""><font color="#00308f"> <b>contact &nbsp;&nbsp;&nbsp;</b></a></font></span>
        </button>
...
<center>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
          	<p class="breadcrumbs"><span class="mr-2"><a href="index.php"></a></span> <span><font color="#000000"></font></span></p>
            <h1 class="mb-0 bread"><h1><font color="#000000"><B>Contact us</B></font></h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Phone:</span> <a href="tel://1234567920"> 1235235598</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="">educlass@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Website</span> <a href="#">educlass.com</a></p>
	          </div>
          </div>
        </div>
						 ...
						 <img src="images/faces/cccc.png" alt="oh" width="" height="100">   
