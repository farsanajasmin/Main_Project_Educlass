      ...
      <!--    <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
			  <li class="nav-item"> <a class="nav-link" href="teachergistration.php">Register Faculty</a></li>
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="studlist.php">Students List</a></li>
				...
				<li class="nav-item"> <a class="nav-link" href="astudentview.php">Students Search</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="parentlist.php">Parents list</a></li>
	            <li class="nav-item"> <a class="nav-link" href="parentdetailes.php">parents detailes</a></li>
        ...
        <section class="signup">
            <div class="container">
                <div class="signup-content">
					...
					<form action="trsearch.php" method="post" enctype="multipart/form-data">

<table  align="left">

  <tr>
  
                <td colspan="3"  rowspan="1" align="center"><h2 style="blue"><b>Teacher Details </b> </h2><br><br></td>
                
               
      </tr>
                <td style="color:#000000"><b>Select Teacher:</b></td>
                
              <td><select id="t_id" name="t_id" class="form-control">
                    <option value="0" selected="selected">- -Select- -</option>
                    <?php
                    $sql="SELECT * FROM tregister WHERE status!='1'";
 ...
 <table   align="center" cellspacing="10" cellpadding="10" width="400" >
   <tr>
	...
	<?php
	$sql1="SELECT * FROM tregister WHERE tregister.t_id=".$t_id;
  ...
  <tr>
   <tr><td colspan="3" align="center"> Teacher details </td></tr>  
  	<tr><th align="left" >Register Number</th><th>:</th><th><?=$t_id?></th></tr>
    ...
    <tr><th align="left" >qualification</th><th>:</th><th><?=$qualification?></th></tr>
    <tr> <th align="left" >email</th><th>:</th> <th><?=$email?></th></tr>
    <tr><th align="left" >Phone Number</th><th>:</th> <th><?=$phone?></th></tr>
    <tr><th align="left" >password</th><th>:</th><th><?=$password?></th></tr> 
