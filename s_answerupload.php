...
<body>
      ...
      <table >
            ...
            <tr>
   <td  align="center"><h3><b>answer</b></h3></td><br>
   </tr> 
	...
	<?php
	$sql13 = "SELECT * FROM tbl_quesions where bch_id='$bch_id'";
    ...
    <tr>
	 ...
	 <?php $sql="SELECT * FROM tbl_subjects where sbid= '$sbid'";
      ...
      <td><div class="form-group">
                      <label for="exampleInputUsername1">ansewr</label><br><br><br>
