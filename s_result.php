...
<body>
        ...
        <!-- Sign up form -->
		  ...
		  <table class="table table-bordered">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>answer</b></h3></td><br>
   </tr> 
...
<tr>
	<?php
					...
					?>
			<?php
	$sql13 = "SELECT * FROM tbl_quesions where bch_id='$batch'";
		   ...
		   $date= date('Y-m-d'); ?>
			 ...
			 <form action="" method="post" enctype="multipart/form-data" >
					...
					<td><div class="form-group">
                      <label for="exampleInputUsername1">upload marks</label><br><br><br>
                       <input type="number" name="marks" id="marks" placeholder="phone"  class="form-control" required>
                    </div>
