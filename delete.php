...
<body>
 ...
 if (isset($_POST['delete'])) {
    ...
    $email=$row2['email'];
    $sql1="update tregister t1,users t2 SET t1.status ='1',t2.status ='1' WHERE t1.email='$email' AND t2.email='$email'";
           ...
           <form class="forms-sample"  method="POST">
		    <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone" value="<?php echo $row['phone']; ?>">
                 ...
                 <button type="submit" name="delete" class="btn btn-primary mr-2" value="addclass">Resign</button>
