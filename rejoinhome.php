...
<body>
  <div class="container-scroller">
   ...
   <td colspan="10" align="center"><h3><b>Teachers List</b></h3></td>
	...
	<?php
	$sql="SELECT t_id,name,email FROM tregister WHERE status!='0'";
  ...
  <tr>
    ...
    <td><?=$name?></td>
	 ...
	 <td>
				...
				<button type="button" class="btn btn-primary btn-xs dt-edit">  <a href="rejoin.php?id=<?php echo $row['t_id'];?>"> 
					<span class="glyphicon glyphicon-pencil" aria-hidden="true">Rejoin</span></a>
				</button>
			</td>
