  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <h4> <a class="navbar-brand brand-logo mr-5" href="index.html"><b>&nbsp;EDUCLASS<img src="images/faces/cccc.png" alt="oh" width="44" height="512"></b></a></h4>
...
<body>
 ...
 $sql="SELECT * FROM tregister where email='$msg2'";
    ...
    $sql1 = "UPDATE `tregister` SET `name`='$name',`age`='$age',`address`='$address',`gender`='$gender',`qualification`='$qualification',`experience`='$experience',`password`='$password',`phone`='$phone'  WHERE email='$msg2'" ;
