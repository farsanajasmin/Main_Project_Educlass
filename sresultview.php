...
<body>
        ...
        <div class="col-lg-10 stretch-card">
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>View Marks</b></h3></td>
   </tr> 
	...
	$sql10 ="select * from tbl_studentregister where email='$msg'";
	...
	$sql13 = "SELECT * FROM tbl_answers where tbl_answers.stu_id ='$stu_id'";
