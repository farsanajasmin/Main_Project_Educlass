...
$msg=$_SESSION['Logid'];
					...
					?>
	<?php
	$sql1="select * from tbl_studentregister t1,users t2  WHERE t1.email='$msg' AND t2.email='$msg'";
  ...
  <tr>
   <tr><td colspan="3" align="center"><b><h3> Student details<h3></b> </td></tr>  
  	<tr><th align="left" >Register Number</th><th>:</th><th><?=$regno?></th></tr>
	...
	<tr><th align="left" >account number</th><th>:</th><th><?=$ac_no?></th></tr>
