...
<body>
  <div class="container-scroller">
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
					...
					<tr>
					<th>
                    <button type="submit" name="adddivision" class="btn btn-primary mr-2" value="adddivision">Add</button></th>
                   </form>
                    <form>
   ...
   <td colspan="10" align="center"><h3><b>Division</b></h3></td>
	...
	<?php
	$sql="SELECT * FROM tbl_division ORDER BY division ASC";
  ...
  <tr>
	...
	<!-- <td>
	 ...
	 <input type="hidden" name="div_id" id="div_id" value="<
      <div class="form-group">
                     
                    </div>
      
              
						<button type="submit"  class="btn btn-inverse-danger btn-fw" name="deletedivision" >Delete</button>
