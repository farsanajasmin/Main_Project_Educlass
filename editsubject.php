	  ...
	  
{
   ...
   $sql="SELECT * FROM tbl_subjects where sbid=$sbid";
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                    ...
                    <div class="form-group">
			         ...
			         <input type="hidden" name="sbid" id="sbid" value="<?php echo $row['sbid']; ?>">
                      <input type="text" class="form-control" id="subject" placeholder="subject" value=<?php echo $subject; ?> name="subject" required>
                     </div>
                    ...
                    <button type="submit" name="updatesub" class="btn btn-primary mr-2" value="updatesub">Update</button>
