...
<?php
	...
	$sql18= "SELECT COUNT(*) as count FROM users where utype='A' AND status!='1'";
					...
					$sql18= "SELECT COUNT(*) as count FROM users where utype='T' AND status!='1'";
					...
					$sql18= "SELECT COUNT(*) as count FROM users where utype='S' AND status!='1'";
					...
					$sql19= "SELECT COUNT(*) as count FROM tbl_studentregister where gender='male' AND status!='1'";
					...
					$sql19= "SELECT COUNT(*) as count FROM tbl_studentregister where gender='female' AND status!='1'";
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-toggle="dropdown">
              <i class=""></i><!--icon-bell mx-0-->
              <span class=""></span>            </a><!--count-->
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $msg ?></p>
                    <!--  <p>10.00% (30 days)</p>-->
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $msg2 ?></p>
                   <!--   <p>22.00% (30 days)</p>-->
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                     Number of students : &nbsp;&nbsp; <h3><?php echo $msg3 ?><br></h3>
                     Number of boys :<?php echo $msg4 ?>&nbsp;<br>
                     Number of girls :<?php echo $msg5 ?>
                      <p class="fs-30 mb-2">
                     <!-- <p>2.00% (30 days)</p>-->
                    </div>
                  </div>
                ...
                <div class="col-md-6 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $msg3 ?></p>
                    <!--  <p>0.22% (30 days)</p>-->
                    </div>
                  </div>
                </div>
