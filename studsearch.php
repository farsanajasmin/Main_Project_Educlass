      ...
      <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
			  ...
			  <li class="nav-item"> <a class="nav-link" href="teachergistration.php">Register Faculty</a></li>
				...
				<li class="nav-item"><a class="nav-link" href="">Faculty Detailes</a></li>
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="studlist.php">Students List</a></li>
				...
				<li class="nav-item"> <a class="nav-link" href="">Students Search</a></li>
...
global $batch;
 if(isset($_POST['bch_id']))
	...
	<?php
	$sql="SELECT * FROM tbl_studentregister WHERE bch_id='$batch'";
