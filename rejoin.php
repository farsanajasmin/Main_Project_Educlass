...
<body>
 ...
 if (isset($_POST['delete'])) {
    ...
    $sql2="SELECT * FROM tregister where t_id=$s_id";
    $result2=mysqli_query($db, $sql2);
    $row2 = mysqli_fetch_assoc($result2);

    $email=$row2['email'];
    $sql1="update tregister t1,users t2 SET t1.status ='0',t2.status ='0' WHERE t1.email='$email' AND t2.email='$email'";
           ...
           <form class="forms-sample"  method="POST">
		    <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone" value="<?php echo $row['phone']; ?>">
                 ...
                 <button type="submit" name="delete" class="btn btn-primary mr-2" value="addclass">Rejoin</button>
