...
<body>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
					  <h2 class="form-title">Excel Upload</h2>
	...
	<?php
	if(isset($_FILES['excelDoc']['name'])){
	$con=mysqli_connect("localhost","root","","educlass");
	include "xlsx.php";
	if($con){
		$excel=SimpleXLSX::parse($_FILES['excelDoc']['tmp_name']);
		//echo "<pre>";	
