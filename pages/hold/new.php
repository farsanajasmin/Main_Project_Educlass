          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
			  ...
			  <li class="nav-item"> <a class="nav-link" href="">Register Faculty</a></li>
                <li class="nav-item"><a class="nav-link" href="teachersview.php">Faculty List</a></li>
...
<body>
 ...
 $sql="SELECT * FROM tregister where t_id=$s_id";
 ...
 if (isset($_POST['update'])) {
    ...
    $sql1 = "UPDATE `tregister` SET `name`='$name',`age`='$age',`gender`='$gender',`address`='$address',`qualification`='$qualification',`experience`='$experience',`phone`='$phone'  WHERE t_id=$s_id" ;
