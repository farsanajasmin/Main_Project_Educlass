    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown2"><img src="images/faces/face24.jpg" alt="profile"/></a></a>
        ...
        <!--  <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
			  <li class="nav-item"> <a class="nav-link" href="sprofileview.php">View Profile</a></li>
                <li class="nav-item"><a class="nav-link" href="supdate.php">Edit Profile</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="sattendanceview.php">View Attendance</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
	            ...
	            <li class="nav-item"> <a class="nav-link" href="snotedowload.php">Download Notes</a></li>
           ...
           <a class="nav-link" data-toggle="collapse" href="#icons" aria-expanded="false" aria-controls="icons">
            ...
            <div class="collapse" id="icons">
              <ul class="nav flex-column sub-menu">
				...
				<li class="nav-item"> <a class="nav-link" href="sviewshedule.php">View Schedules</a></li>
          ...
          <li class="nav-item">
           <a class="nav-link" data-toggle="collapse" href="#auth" aria-expanded="false" aria-controls="auth">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
      <li class="nav-item"> <a class="nav-link" href="student_examview.php"> View Schedule </a></li>
              
				 <li class="nav-item"> <a class="nav-link" href="s_anup.php">Upload Answer</a></li>
				  <li class="nav-item"> <a class="nav-link" href="sresultview.php">View Mark</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
