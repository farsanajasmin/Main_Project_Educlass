...
<body>
 ...
 if (isset($_POST['delete'])) {
   ...
   $sql2="SELECT * FROM tbl_studentregister where stu_id='$s_id'";
    $result2=mysqli_query($db, $sql2);
    $row2 = mysqli_fetch_assoc($result2);

    $email=$row2['email'];
    $sql1="update tbl_studentregister t1,users t2 SET t1.status ='1',t2.status ='1' WHERE t1.email='$email' AND t2.email='$email'";
	 ...
	 if($result)
		 {
			echo '<script type="text/javascript">
                      ...
                      alert("student droped");
                         location="studentview.php";
                           </script>';
		 }
		 else
		 {
           ...
           <form class="forms-sample"  method="POST">
		    <div class="form-group">
                ...
                <input type="text" class="form-control" name="password" value="<?php echo $row['password']; ?>">
                 ...
                 <button type="submit" name="delete" class="btn btn-primary mr-2" value="addclass">drop</button>
