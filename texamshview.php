...
<body>
   ...
   <td colspan="10" align="center"><h3><b>Questions</b></h3></td>
	...
	<?php
	$sql13 = "SELECT * FROM tbl_quesions";
    ...
    <tr>
	 ...
	 <form action="dosaaving.php" method="post" enctype="multipart/form-data" >          
      ...
      <div class="form-group">
          ...
          <input type="hidden" name="q_id" id="q_id" value="<?php echo $file['q_id']; ?>">
         
						<button type="submit"  class="btn btn-inverse-danger btn-fw" name="delete_examschedule" >Delete</button>
