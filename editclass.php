	  ...
	  
{
   ...
   $sql="SELECT * FROM tbl_class where c_id=$c_id";
	...
	?>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="forms-sample" action="dosaaving.php" method="post">
                    ...
                    <div class="form-group">
                      <label for="exampleInputUsername1">Standard</label>
			<input type="hidden" name="c_id" id="c_id" value="<?php echo $row['c_id']; ?>">
                    ...
                    <button type="submit" name="updateclass" class="btn btn-primary mr-2" value="updateclass">Update</button>
...
?>
            ...
            <tr>
   <td colspan="10" align="center"><h3><b>Standard</b></h3></td>
   </tr> 
      <tr class="table-info">
   ...
   <tr>
    <td><?=$class?></td>
    <td> <form action="editclass.php" method="post" enctype="multipart/form-data" >          
      ...
      <div class="form-group">
          ...
          <input type="hidden" name="c_id" id="c_id" value="<?php echo $row['c_id']; ?>">
              <button type="submit" class="btn btn-primary btn-icon-text" name="edit">
      ...
      <!-- <button type="submit" name="edit" value="edit" class="btn btn-inverse-danger btn-fw">Delete</button>-->
  <?php
  $regno++;
	}
