            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                      <h3 class="form-title">Teacher Registration</h3>
                         ...
                         <form action= "dosaaving.php" method="post">
                           ...
                           <!-- <div class="form-group">
							...
							<tr>
							<th><br>
                                <input type="submit" name="register" id="signup" onclick="registration()" class="btn btn-primary mr-2"  value="Register"/></th>
								     </form>
                    <form>
				 <th><br>&nbsp;&nbsp;&nbsp;&nbsp;  <button class="btn btn-light" onClick="document.location.href='class.php'"/>Cancel</button></th></tr>
				  </form>
				  </table>
                            </div>
                        </form>
